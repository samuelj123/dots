...
# {{{2 Packages General
  home-manager.users.sam = { pkgs, ... }: {
    ...
    # Wayland Stuff
      eww-wayland dunst rofi-wayland swww 
    # Graphics 
      krita logseq
    # Development
    # Language Servers
      nodejs nodePackages_latest.npm nodePackages_latest.typescript-language-server nodePackages_latest.svelte-language-server nodePackages_latest.firebase-tools # Node Tools
